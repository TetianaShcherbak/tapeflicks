...
public interface RentalRepository extends JpaRepository<Rental, Long> {
    ...
    /**
     * Finds active rentals whose due date falls at or before the given threshold
     * and for which a reminder has not yet been sent.
     *
     * <p>Used by the due-date reminder scheduler to identify rentals
     * that require a notification within the upcoming reminder window.
     *
    ...
    @Query("""
            ...
            """)
    List<Rental> findAllCurrentRentalsByUserId(@Param("userId") Long userId); // fix: added missing @Param
    ...
    @Query("""
            ...
            """)
    List<Rental> findAllReturnedMoviesByUserId(@Param("userId") Long userId); // fix: added missing @Param
}